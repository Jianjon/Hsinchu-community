...
exports.runCrawlerLogic = void 0;
...
const runCrawlerLogic = async () => {
    ...
    for (const item of newsItems) {
        ...
        batch.set(ref, Object.assign(Object.assign({}, item), { valid: true, stats: { likes: 0, comments: 0, views: 0 }, createdAt: admin.firestore.Timestamp.fromDate(item.createdAt) }));
    }
...
exports.runCrawlerLogic = runCrawlerLogic;
